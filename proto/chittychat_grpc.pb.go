...
func (c *chittyChatClient) JoinChat(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[BroadcastMessage], error) {
...
type ChittyChat_JoinChatClient = grpc.ServerStreamingClient[BroadcastMessage]

func (c *chittyChatClient) PublishMessage(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *chittyChatClient) LeaveChat(ctx context.Context, in *LeaveRequest, opts ...grpc.CallOption) (*LeaveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedChittyChatServer) JoinChat(*JoinRequest, grpc.ServerStreamingServer[BroadcastMessage]) error {
	return status.Errorf(codes.Unimplemented, "method JoinChat not implemented")
}
func (UnimplementedChittyChatServer) PublishMessage(context.Context, *PublishRequest) (*PublishResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PublishMessage not implemented")
}
func (UnimplementedChittyChatServer) LeaveChat(context.Context, *LeaveRequest) (*LeaveResponse, error) {
...
func _ChittyChat_JoinChat_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChittyChatServer).JoinChat(m, &grpc.GenericServerStream[JoinRequest, BroadcastMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChittyChat_JoinChatServer = grpc.ServerStreamingServer[BroadcastMessage]
